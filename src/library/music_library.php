...
<!-- navigation -->
	...
	<table width="1000" border="0"align="center" style="color: white; border-left: 2px; border-left-color: #4fccc6;">
			...
			<?php
			require("connect.php");
			$query="select s.song_name, s.song_price, a.album_name, b.artist_name, g.genre_name, a.album_image
			...
			?>
			<tr align="center">
				<td class="songs" width="50"><img src="album_images/<?php echo $song_picture ?>" width="200" height="160"></td>
