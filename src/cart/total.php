...
$( "#hello" ).dialog({ autoOpen: false,minHeight: 300,minWidth:800 })
...
<center><h1>Change shipping address</h1></center>
		...
		<form action="" method="post" name="shipdd">
			<table>
				...
				<tr>
					...
					<td><input type="text" name="cname" placeholder="Name with intials" size="35"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="phone" placeholder="phone number" size="35"></td>
				</tr>
				<tr>
					<td colspan="1">
