...
<!-- navigation -->
	<div style="position: fixed; float: left; width: 20%;border: 2; border-color: #4fccc6;">
		<nav style="margin-top: 40%; border: 2; border-color: #4fccc6;">
		<a href="music_library.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">All</a></br></br>
		<a href="music_library_am.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">Alternative Metal</a></br></br>
		<a href="music_library_ar.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">Alternative Rock</a></br></br>
		<a href="music_library_co.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">Country</a></br></br>
		<a href="music_library_da.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">Dance</a></br></br>
		<a href="music_library_du.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">Dubstep</a></br></br>
		<a href="music_library_hm.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">Heavy Metal</a></br></br>
		<a href="music_library_po.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">Pop</a></br></br>
		<a href="music_library_rb.php" style="margin-left: 3%; text-decoration: none; color: #4fccc6">R&B</a></br></br>
	...
	<table width="1000" border="0"align="center" style="color: white; border-left: 2px; border-left-color: #4fccc6;">
			<tr>
			...
			<tr style="margin-bottom: 50px; padding-bottom: 50px;">
				<th style="color=; margin-bottom: 50px;"></th>
				<th style="background-color: rgb(87,87,87); margin-bottom: 50px;width: 150px;">Song Name</th>				
				<th style="background-color: rgb(87,87,87); margin-bottom: 50px;width: 150px;">Album Name</th>
				<th style="background-color: rgb(87,87,87); margin-bottom: 50px;width: 150px;">Artist Name</th>
				<th style="background-color: rgb(87,87,87); margin-bottom: 50px;">Genure Name</th>
				<th style="background-color: rgb(87,87,87); margin-bottom: 50px;width: 100px;">Song Price (USD)</th>
			</tr>
			<tr><td></td></tr>
			<?php
			require("connect.php");
			$query="select s.song_name, s.song_price, a.album_name, b.artist_name, g.genre_name, a.album_image,s.song_id
					...
					where s.album_id=a.album_id and s.artist_id=b.artist_id and s.genre_id=g.genre_id";
			...
			<tr align="center">
				...
				<td class="songs" width="80"><?php echo $song_name ?></td>
				<td class="songs" width="40"><?php echo $album_name ?></td>
				<td class="songs" width="40"><?php echo $artist_name ?></td>
				<td class="songs" width="1"><?php echo $genre_name ?></td>
				<td class="songs" width="50"><?php echo $song_price ?></td>
				<td>
					<form id="form1" name="form1" method="post" action="content.php">
						<input type="hidden" name="pid" id="pid" value="<?php echo $song_id;?>"/>
						<input type="submit" class="add" name="button" id="button" value="Add to Cart"/>
					</form>
