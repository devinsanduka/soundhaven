...
<<html>
	...
	<div id="search" style=" margin-top: 80px;">
		...
		<table width="1000" border="0"align="center">
			...
			$construct1="SELECT artist_name,artist_pic,artist_bio 
			             FROM  artist
			...
			while($row1=mysqli_fetch_array($results1))
			{
				...
				$artistpicture=$row1['artist_pic'];
				$artistbio=substr($row1['artist_bio'],0,100);
			?>
			<tr align="center">
				<td class="songs" width="20"><?php echo $artistid; ?></td>
				<td class="songs" width="70"><?php echo $artistname; ?></td>
				<td class="songs" width="50"><img src="artist_images/<?php echo $artistpicture; ?>" width="50" height="40"></td>
				<td class="songs" width="30"><?php echo $artistbio; ?></td>
				<td class="songs" width="1"><a class="blue" href="edit_artist.php?edit_ar=<?php echo $artistid; ?>">Update</a></td>
			</tr>
			<?php } ?>
