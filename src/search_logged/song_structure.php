...
<!-- navigation -->
	...
	<table width="500" border="0" align="center" style="color: white; margin-right: 50%;">
			<?php
			//require("connect.php");
	 ...
	 $construct1= "SELECT song_name,album_name
	                  FROM album alb,song s
	                  WHERE s.album_id=alb.album_id AND s.song_id=' $songid'   ";
	
	 $construct2= "SELECT artist_name,genre_name,song_price
	                  FROM song s,artist art,genre g
	                  WHERE s.artist_id=art.artist_id AND   g.genre_id=s.genre_id  AND  s.song_id=' $songid'   ";
	           ...
	           $results2=mysqli_query( $con,$construct2);
						...
						$song_price=$row2['song_price'];
		
			?>
			<tr>
				<td class="songs" width="50" rowspan="7"><img src="album_images/<?php echo $song_picture ?>" width="220" height="220"></td>
				<td class="songs" width="30"><?php echo $song_name ?></td>
				<tr>
				...
				<tr>
				<td class="songs" width="30"><?php echo $genre_name ?></td>
				</tr>
				<tr>
				<td class="songs" width="10"><?php echo $song_price ?></td>
				</tr>
