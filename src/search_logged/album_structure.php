...
<!-- navigation -->
	...
	<table width="600" border="0" align="center" style="color: white; margin-left: 20%;">
	    ...
	    $construct1= "SELECT album_name,artist_name,album_desc,album_price,genre_name
	                  FROM album alb,artist art,genre g
	                  WHERE alb.artist_id=art.artist_id AND  g.genre_id=alb. genre_id AND alb.album_id=' $albumid'   ";
					  
					   $results1=mysqli_query($con,$construct1);
					   $row1=mysqli_fetch_assoc($results1);
			              $album_name=$row1['album_name'];
						  $artist_name=$row1['artist_name'];
						  $album_dis=$row1['album_desc'];
						  $album_price=$row1['album_price'];
						  $genre_name=$row1['genre_name'];
		
		
			?>
			<tr>
				<td class="songs" width="50" rowspan="4"><img src="album_images/<?php echo $artist_picture ?>" width="220" height="220"></td>
				<td class="songs" width="40">Album Name: <?php echo $album_name ?></td>
				<tr>
				<td class="songs" width="40">Artist Name: <?php echo $artist_name ?></td>
				</tr>
				<tr>
				<td class="songs" width="40">Genre: <?php echo $genre_name ?></td>
				</tr>
				<tr>
				<td class="songs" width="10">Album Price: <?php echo $album_price ?></td>
				</tr>
				
				
		</table>
		
		<table width="500" border="0" align="center" style="color: white; margin-right: ; margin-top: 5%;">
			<th align="center" style="margin-bottom: 10px;">Songs</th>
			<?php
			//require("connect.php");
			   $con=mysqli_connect("localhost","root","","soundhaven");
			   ...
			   if (mysqli_connect_errno()) {
			     ...
			     $construct2= "SELECT song_name
	                  FROM song s,album alb
	                  WHERE alb.album_id=s.album_id AND alb.album_id=' $albumid'   ";      
			...
			?>
			<tr>
				<td class="songs" width="100" align="center"><?php echo $song_name ?></td>
			</tr>
			<?php } ?>
